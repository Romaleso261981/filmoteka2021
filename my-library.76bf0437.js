...
r.movieDetails.addEventListener("click",(async function(e){if(!e.target.closest("li"))return;{const o=e.target.closest("li");u=Number(o.getAttribute("key")),function(e){const o=[...t(),...a()].find((t=>t.id==e));m=o}
//! ПОКАЗЫВАЕМ Spinner
...
//# sourceMappingURL=my-library.76bf0437.js.map
