...
l.myLibraryBtn.addEventListener("click",f),
...
d.default.startSpinner(),"watched"===i&&(c=u.find((e=>e.id===s)));"queue"===i&&(c=b.find((e=>e.id===s)));
//! ==> Открываем модалку
...
l.watchedHeader.addEventListener("click",f),l.queueHeader.addEventListener("click",(function(){var e;
...
y();
//! Рисование интерфейса
w(null!==(e=JSON.parse(localStorage.getItem("queue")))&&void 0!==e?e:[])}
