...
l.homeBtn.addEventListener("click",b),
//! Создаем слушателя событий на кнопке Filmoteka:
l.filmotekaBtn.addEventListener("click",b),
//! Создаем слушателя событий на кнопке MY LIBRARY:
l.myLibraryBtn.addEventListener("click",(function(){var e;
...
//! Кнопка LOAD MORE => показываем и отключаем
//! Очищаем контейнер:
k();const t=null!==(e=JSON.parse(localStorage.getItem("watched")))&&void 0!==e?e:[];console.log("results:",t),//!
//! Рисование интерфейса 
...
//! ==> Открываем модалку
window.addEventListener("keydown",T),document.body.classList.add("show-modal"),
//! Прячем Spinner
u.default.removeSpinner(),
//! Рисование интерфейса
n=p,
...
l.watchedModal.addEventListener("click",x),l.queueModal.addEventListener("click",I),
...
"home-Filmoteka"!==m&&"Movie search"!==m||y.find((e=>e.id===p.id))&&(t(i).Notify.warning(`Фильм ${p.title||p.name} уже есть в WATCHED`,{timeout:3500}),l.watchedModal.textContent="DELETE FROM WATCHED",l.watchedModal.classList.contains("colorGreen")&&l.watchedModal.classList.remove("colorGreen"),l.watchedModal.classList.contains("colorRed")||l.watchedModal.classList.add("colorRed"));
...
"home-Filmoteka"!==m&&"Movie search"!==m||w.find((e=>e.id===p.id))&&(t(i).Notify.warning(`Фильм ${p.title||p.name} уже есть в QUEUE`,{timeout:3500}),l.queueModal.textContent="DELETE FROM QUEUE",l.queueModal.classList.contains("colorGreen")&&l.queueModal.classList.remove("colorGreen"),l.queueModal.classList.contains("colorRed")||l.queueModal.classList.add("colorRed"));
...
l.closeModalBtn.addEventListener("click",_),l.backdrop.addEventListener("click",(function(e){e.currentTarget===e.target&&_()})),
...
let y=null!==(g=JSON.parse(localStorage.getItem("watched")))&&void 0!==g?g:[];var v;let w=null!==(v=JSON.parse(localStorage.getItem("queue")))&&void 0!==v?v:[];
...
S(e),
//! Прячем Spinner
u.default.removeSpinner()}function x(){console.log("Вешаю слушателя на кнопку ADD TO WATCHED в МОДАЛКЕ"),//!
...
if(y.find((e=>e.id===p.id)))return t(i).Notify.warning(`Фильм ${p.title||p.name} уже есть в WATCHED`,{timeout:3500}),l.watchedModal.textContent="DELETE FROM WATCHED",l.watchedModal.classList.contains("colorGreen")&&l.watchedModal.classList.remove("colorGreen"),void(l.watchedModal.classList.contains("colorRed")||l.watchedModal.classList.add("colorRed"));
//! Запись фильма в localStorage
y=[...y,p],console.log("localStorageWatched:",y),//!
localStorage.setItem("watched",JSON.stringify(y)),t(i).Notify.success(`Фильм ${p.title||p.name} добавлен в WATCHED`,{timeout:3500}),
//! Смена названия (textContent) кнопки на "DELETE FROM WATCHED"
l.watchedModal.textContent="DELETE FROM WATCHED",l.watchedModal.classList.contains("colorGreen")&&l.watchedModal.classList.remove("colorGreen"),l.watchedModal.classList.contains("colorRed")||l.watchedModal.classList.add("colorRed"),console.log("textWatchedModal ==> конец:",e)}else"DELETE FROM WATCHED"===e&&(y=y.filter((e=>e.id!==p.id)),localStorage.setItem("watched",JSON.stringify(y)),console.log("Фильм удален из WATCHED"),//!
...
_(),
//! Очищаем контейнер:
k(),appendWatchedQueueMarkup(y)))}function I(){console.log("Вешаю слушателя на кнопку ADD TO QUEUE в МОДАЛКЕ"),//!
console.log("infoFilm:",p),//!
console.log("infoFilm.id:",p.id);//!
const e=l.queueModal.textContent;//!
if(console.log("textQueuedModal ==> начало:",e),"ADD TO QUEUE"===e){
//! Блокировка повторной записи фильма в localStorage 
if(w.find((e=>e.id===p.id)))return t(i).Notify.warning(`Фильм ${p.title||p.name} уже есть в QUEUE`,{timeout:3500}),l.queueModal.textContent="DELETE FROM QUEUE",l.queueModal.classList.contains("colorGreen")&&l.queueModal.classList.remove("colorGreen"),void(l.queueModal.classList.contains("colorRed")||l.queueModal.classList.add("colorRed"));
//! Запись фильма в localStorage
w=[...w,p],console.log("localStorageQueue:",w),//!
localStorage.setItem("queue",JSON.stringify(w)),t(i).Notify.success(`Фильм ${p.title||p.name} добавлен в QUEUE`,{timeout:3500}),
//! Смена названия (textContent) кнопки на "DELETE FROM QUEUE"
l.queueModal.textContent="DELETE FROM QUEUE",l.queueModal.classList.contains("colorGreen")&&l.queueModal.classList.remove("colorGreen"),l.queueModal.classList.contains("colorRed")||l.queueModal.classList.add("colorRed"),console.log("textQueuedModal ==> конец:",e)}else"DELETE FROM QUEUE"===e&&(w=w.filter((e=>e.id!==p.id)),localStorage.setItem("queue",JSON.stringify(w)),console.log("Фильм удален из QUEUE"),t(i).Notify.info(`Фильм ${p.title||p.name} удален из QUEUE`,{timeout:3500}),l.queueModal.textContent="ADD TO QUEUE",l.queueModal.classList.contains("colorRed")&&l.queueModal.classList.remove("colorRed"),l.queueModal.classList.contains("colorGreen")||l.queueModal.classList.add("colorGreen"),"queue"===m&&(console.log("currentPage",m),//!
_(),
//! Очищаем контейнер:
k(),appendWatchedQueueMarkup(w)))}function k(){l.moviesCards.innerHTML=""}
//!  Ф-ция, к-рая очищает контейнер МОДАЛКИ:
function E(){l.InfoMovie.innerHTML=""}function _(){window.removeEventListener("keydown",T),document.body.classList.remove("show-modal"),
//! Очищаем контейнер МОДАЛКИ:
E()}function T(e){"Escape"===e.code&&_()}
 ...
 */
s("kP9ko").default.registerVersion("firebase","9.10.0","app-compat")})),s.register("kP9ko",(function(e,t){n(e.exports,"default",(function(){return f}));var r=s("2xDiJ"),i=s("6ExWU"),o=s("MjY8E"),a=(o=s("MjY8E"),s("kZfxc"));
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function M(e){return e&&e._delegate?e._delegate:e}})),s.register("6ExWU",(function(e,t){n(e.exports,"Component",(function(){return i})),n(e.exports,"ComponentContainer",(function(){return c}));var r=s("2xDiJ");class i{setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}constructor(e,t,n){this.name=e,this.instanceFactory=t,this.type=n,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var z;z="",v(new(0,r.Component)("platform-logger",(e=>new c(e)),"PRIVATE")),v(new(0,r.Component)("heartbeat",(e=>new B(e)),"PRIVATE")),A(u,l,z),A(u,l,"esm2017"),A("fire-js","")})),s.register("kZfxc",(function(e,t){n(e.exports,"LogLevel",(function(){return i})),n(e.exports,"Logger",(function(){return l})),n(e.exports,"setLogLevel",(function(){return h})),n(e.exports,"setUserLogHandler",(function(){return d}));
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var P;(P=r.default).INTERNAL.registerComponent(new(0,a.Component)("auth-compat",(e=>{const t=e.getProvider("app-compat").getImmediate(),n=e.getProvider("auth");return new A(t,n)}),"PUBLIC").setServiceProps({ActionCodeInfo:{Operation:{EMAIL_SIGNIN:i.A.EMAIL_SIGNIN,PASSWORD_RESET:i.A.PASSWORD_RESET,RECOVER_EMAIL:i.A.RECOVER_EMAIL,REVERT_SECOND_FACTOR_ADDITION:i.A.REVERT_SECOND_FACTOR_ADDITION,VERIFY_AND_CHANGE_EMAIL:i.A.VERIFY_AND_CHANGE_EMAIL,VERIFY_EMAIL:i.A.VERIFY_EMAIL}},EmailAuthProvider:i.M,FacebookAuthProvider:i.N,GithubAuthProvider:i.T,GoogleAuthProvider:i.Q,OAuthProvider:i.U,SAMLAuthProvider:i.V,PhoneAuthProvider:L,PhoneMultiFactorGenerator:i.m,RecaptchaVerifier:O,TwitterAuthProvider:i.W,Auth:A,AuthCredential:i.H,Error:c.FirebaseError}).setInstantiationMode("LAZY").setMultipleInstances(!1)),P.registerVersion("@firebase/auth-compat","0.2.20")})),s.register("beEBC",(function(e,t){n(e.exports,"cordovaPopupRedirectResolver",(function(){return m})),n(e.exports,"addFrameworkForLogging",(function(){return y})),n(e.exports,"ActionCodeOperation",(function(){return s("arqsC").A})),n(e.exports,"AuthCredential",(function(){return s("arqsC").H})),n(e.exports,"EmailAuthProvider",(function(){return s("arqsC").M})),n(e.exports,"FacebookAuthProvider",(function(){return s("arqsC").N})),n(e.exports,"GithubAuthProvider",(function(){return s("arqsC").T})),n(e.exports,"GoogleAuthProvider",(function(){return s("arqsC").Q})),n(e.exports,"OAuthCredential",(function(){return s("arqsC").J})),n(e.exports,"OAuthProvider",(function(){return s("arqsC").U})),n(e.exports,"PhoneAuthProvider",(function(){return s("arqsC").P})),n(e.exports,"PhoneMultiFactorGenerator",(function(){return s("arqsC").m})),n(e.exports,"ProviderId",(function(){return s("arqsC").o})),n(e.exports,"RecaptchaVerifier",(function(){return s("arqsC").R})),n(e.exports,"SAMLAuthCredential",(function(){return s("arqsC").aL})),n(e.exports,"SAMLAuthProvider",(function(){return s("arqsC").V})),n(e.exports,"TwitterAuthProvider",(function(){return s("arqsC").W})),n(e.exports,"_assert",(function(){return s("arqsC").ax})),n(e.exports,"_castAuth",(function(){return s("arqsC").aE})),n(e.exports,"_fail",(function(){return s("arqsC").at})),n(e.exports,"_generateEventId",(function(){return s("arqsC").aI})),n(e.exports,"_getInstance",(function(){return s("arqsC").ay})),n(e.exports,"_getRedirectResult",(function(){return s("arqsC").aB})),n(e.exports,"_overrideRedirectResult",(function(){return s("arqsC").aC})),n(e.exports,"_persistenceKeyName",(function(){return s("arqsC").az})),n(e.exports,"applyActionCode",(function(){return s("arqsC").a2})),n(e.exports,"browserLocalPersistence",(function(){return s("arqsC").b})),n(e.exports,"browserPopupRedirectResolver",(function(){return s("arqsC").k})),n(e.exports,"browserSessionPersistence",(function(){return s("arqsC").a})),n(e.exports,"checkActionCode",(function(){return s("arqsC").a3})),n(e.exports,"confirmPasswordReset",(function(){return s("arqsC").a1})),n(e.exports,"connectAuthEmulator",(function(){return s("arqsC").G})),n(e.exports,"createUserWithEmailAndPassword",(function(){return s("arqsC").a5})),n(e.exports,"debugErrorMap",(function(){return s("arqsC").B})),n(e.exports,"fetchSignInMethodsForEmail",(function(){return s("arqsC").aa})),n(e.exports,"getAdditionalUserInfo",(function(){return s("arqsC").al})),n(e.exports,"getMultiFactorResolver",(function(){return s("arqsC").an})),n(e.exports,"getRedirectResult",(function(){return s("arqsC").j})),n(e.exports,"inMemoryPersistence",(function(){return s("arqsC").L})),n(e.exports,"indexedDBLocalPersistence",(function(){return s("arqsC").i})),n(e.exports,"isSignInWithEmailLink",(function(){return s("arqsC").a8})),n(e.exports,"linkWithCredential",(function(){return s("arqsC").Z})),n(e.exports,"linkWithPhoneNumber",(function(){return s("arqsC").l})),n(e.exports,"linkWithPopup",(function(){return s("arqsC").d})),n(e.exports,"linkWithRedirect",(function(){return s("arqsC").g})),n(e.exports,"multiFactor",(function(){return s("arqsC").ao})),n(e.exports,"reauthenticateWithCredential",(function(){return s("arqsC")._})),n(e.exports,"reauthenticateWithPhoneNumber",(function(){return s("arqsC").r})),n(e.exports,"reauthenticateWithPopup",(function(){return s("arqsC").e})),n(e.exports,"reauthenticateWithRedirect",(function(){return s("arqsC").h})),n(e.exports,"sendEmailVerification",(function(){return s("arqsC").ab})),n(e.exports,"sendPasswordResetEmail",(function(){return s("arqsC").a0})),n(e.exports,"sendSignInLinkToEmail",(function(){return s("arqsC").a7})),n(e.exports,"signInAnonymously",(function(){return s("arqsC").X})),n(e.exports,"signInWithCredential",(function(){return s("arqsC").Y})),n(e.exports,"signInWithCustomToken",(function(){return s("arqsC").$})),n(e.exports,"signInWithEmailAndPassword",(function(){return s("arqsC").a6})),n(e.exports,"signInWithEmailLink",(function(){return s("arqsC").a9})),n(e.exports,"signInWithPhoneNumber",(function(){return s("arqsC").s})),n(e.exports,"signInWithPopup",(function(){return s("arqsC").c})),n(e.exports,"signInWithRedirect",(function(){return s("arqsC").f})),n(e.exports,"unlink",(function(){return s("arqsC").ak})),n(e.exports,"updateEmail",(function(){return s("arqsC").ag})),n(e.exports,"updatePassword",(function(){return s("arqsC").ah})),n(e.exports,"updatePhoneNumber",(function(){return s("arqsC").u})),n(e.exports,"updateProfile",(function(){return s("arqsC").af})),n(e.exports,"verifyBeforeUpdateEmail",(function(){return s("arqsC").ac})),n(e.exports,"verifyPasswordResetCode",(function(){return s("arqsC").a4}));var r=s("arqsC"),i=s("2xDiJ");s("MjY8E"),s("kZfxc"),s("6ExWU");r=s("arqsC");
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function S(){var e;return"undefined"!=typeof self&&(null===(e=self.location)||void 0===e?void 0:e.href)||""}function C(){return"http:"===N()||"https:"===N()}function N(){var e;return"undefined"!=typeof self&&(null===(e=self.location)||void 0===e?void 0:e.protocol)||null}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ne extends xe{static _fromVerification(e,t){return new Ne({verificationId:e,verificationCode:t})}static _fromTokenResponse(e,t){return new Ne({phoneNumber:e,temporaryProof:t})}_getIdTokenResponse(e){return async function(e,t){return B(e,"POST","/v1/accounts:signInWithPhoneNumber",O(e,t))}(e,this._makeVerificationRequest())}_linkToIdToken(e,t){return async function(e,t){const n=await B(e,"POST","/v1/accounts:signInWithPhoneNumber",O(e,t));if(n.temporaryProof)throw q(e,"account-exists-with-different-credential",n);return n}(e,Object.assign({idToken:t},this._makeVerificationRequest()))}_getReauthenticationResolver(e){return async function(e,t){return B(e,"POST","/v1/accounts:signInWithPhoneNumber",O(e,Object.assign(Object.assign({},t),{operation:"REAUTH"})),Ce)}(e,this._makeVerificationRequest())}_makeVerificationRequest(){const{temporaryProof:e,phoneNumber:t,verificationId:n,verificationCode:r}=this.params;return e&&t?{temporaryProof:e,phoneNumber:t}:{sessionInfo:n,code:r}}toJSON(){const e={providerId:this.providerId};return this.params.phoneNumber&&(e.phoneNumber=this.params.phoneNumber),this.params.temporaryProof&&(e.temporaryProof=this.params.temporaryProof),this.params.verificationCode&&(e.verificationCode=this.params.verificationCode),this.params.verificationId&&(e.verificationId=this.params.verificationId),e}static fromJSON(e){"string"==typeof e&&(e=JSON.parse(e));const{verificationId:t,verificationCode:n,phoneNumber:r,temporaryProof:i}=e;return n||t||r||i?new Ne({verificationId:t,verificationCode:n,phoneNumber:r,temporaryProof:i}):null}constructor(e){super("phone","phone"),this.params=e}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kt{constructor(e,t,n={}){this.isNewUser=e,this.providerId=t,this.profile=n}}class Et extends kt{constructor(e,t,n,r){super(e,t,n),this.username=r}}class _t extends kt{constructor(e,t){super(e,"facebook.com",t)}}class Tt extends Et{constructor(e,t){super(e,"github.com",t,"string"==typeof(null==t?void 0:t.login)?null==t?void 0:t.login:null)}}class St extends kt{constructor(e,t){super(e,"google.com",t)}}class Ct extends Et{constructor(e,t,n){super(e,"twitter.com",t,n)}}function Nt(e){const{user:t,_tokenResponse:n}=e;return t.isAnonymous&&!n?{providerId:null,isNewUser:!1,profile:null}:function(e){var t,n;if(!e)return null;const{providerId:r}=e,i=e.rawUserInfo?JSON.parse(e.rawUserInfo):{},s=e.isNewUser||"identitytoolkit#SignupNewUserResponse"===e.kind;if(!r&&(null==e?void 0:e.idToken)){const r=null===(n=null===(t=W(e.idToken))||void 0===t?void 0:t.firebase)||void 0===n?void 0:n.sign_in_provider;if(r)return new kt(s,"anonymous"!==r&&"custom"!==r?r:null)}if(!r)return null;switch(r){case"facebook.com":return new _t(s,i);case"github.com":return new Tt(s,i);case"google.com":return new St(s,i);case"twitter.com":return new Ct(s,i,e.screenName||null);case"custom":case"anonymous":return new kt(s,null);default:return new kt(s,r,i)}}(n)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class N{static documentId(){return new N(r._FieldPath.keyField().canonicalString())}isEqual(e){return(e=(0,i.getModularInstance)(e))instanceof r.FieldPath&&this._delegate._internalPath.isEqual(e._internalPath)}constructor(...e){this._delegate=new(0,r.FieldPath)(...e)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const D={Firestore:f,GeoPoint:r.GeoPoint,Timestamp:r.Timestamp,Blob:l,Transaction:m,WriteBatch:g,DocumentReference:v,DocumentSnapshot:I,Query:E,QueryDocumentSnapshot:k,QuerySnapshot:T,CollectionReference:S,FieldPath:N,FieldValue:A,setLogLevel:function(e){(0,r.setLogLevel)(e)},CACHE_SIZE_UNLIMITED:r.CACHE_SIZE_UNLIMITED};
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ce(){return"undefined"!=typeof atob}let Ne=Symbol.iterator;
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ci{static oe(e,t){const n=t.uid||"";return new Ci(e,n)}getOverlay(e,t){return Ni(e).get(ki(this.userId,t)).next((e=>e?Ii(this.It,e):null))}getOverlays(e,t){const n=qn();return se.forEach(t,(t=>this.getOverlay(e,t).next((e=>{null!==e&&n.set(t,e)})))).next((()=>n))}saveOverlays(e,t,n){const r=[];return n.forEach(((n,i)=>{const s=new hi(t,i);r.push(this.ue(e,s))})),se.waitFor(r)}removeOverlaysForBatchId(e,t,n){const r=new Set;t.forEach((e=>r.add(Mr(e.getCollectionPath()))));const i=[];return r.forEach((t=>{const r=IDBKeyRange.bound([this.userId,t,n],[this.userId,t,n+1],!1,!0);i.push(Ni(e).Y("collectionPathOverlayIndex",r))})),se.waitFor(i)}getOverlaysForCollection(e,t,n){const r=qn(),i=Mr(t),s=IDBKeyRange.bound([this.userId,i,n],[this.userId,i,Number.POSITIVE_INFINITY],!0);return Ni(e).W("collectionPathOverlayIndex",s).next((e=>{for(const t of e){const e=Ii(this.It,t);r.set(e.getKey(),e)}return r}))}getOverlaysForCollectionGroup(e,t,n,r){const i=qn();let s;const o=IDBKeyRange.bound([this.userId,t,n],[this.userId,t,Number.POSITIVE_INFINITY],!0);return Ni(e).Z({index:"collectionGroupOverlayIndex",range:o},((e,t,n)=>{const o=Ii(this.It,t);i.size()<r||o.largestBatchId===s?(i.set(o.getKey(),o),s=o.largestBatchId):n.done()})).next((()=>i))}ue(e,t){return Ni(e).put(function(e,t,n){const[r,i,s]=ki(t,n.mutation.key);return{userId:t,collectionPath:i,documentId:s,collectionGroup:n.mutation.key.getCollectionGroup(),largestBatchId:n.largestBatchId,overlayMutation:xr(e.re,n.mutation)}}(this.It,this.userId,t))}constructor(e,t){this.It=e,this.userId=t}}function Ni(e){return ci(e,"documentOverlays")}
/**
 * @license
 * Copyright 2021 Google LLC
 *
