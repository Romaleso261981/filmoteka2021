...
s.movieDetails.addEventListener("click",(async function(e){if(!e.target.closest("li"))return;{const o=e.target.closest("li");i=Number(o.getAttribute("key")),console.log("idFilms:",i),function(e){const o=[...t(),...a()].find((t=>t.id==e));r=o}
//! ПОКАЗЫВАЕМ Spinner
...
function g(){const t=s.watchedModal.textContent;if("ADD TO WATCHED"===t){
...
w(),L(p)))}
//! +++ Запрос полной информации о фильме для МОДАЛКИ +++
function y(){const t=s.queueModal.textContent;if("ADD TO QUEUE"===t){
//! Блокировка повторной записи фильма в localStorage (ВРЕМЕННО)
...
//# sourceMappingURL=my-library.a0081f95.js.map
