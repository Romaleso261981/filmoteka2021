...
s.movieDetails.addEventListener("click",(async function(e){if(!e.target.closest("li"))return;{const o=e.target.closest("li");u=Number(o.getAttribute("key")),function(e){const o=[...t(),...a()].find((t=>t.id==e));m=o}
//! ПОКАЗЫВАЕМ Spinner
(u)}function t(){try{const e=JSON.parse(localStorage.getItem("queue"))||[];return null===e?[]:e}catch(e){console.log(e)}}function a(){try{const e=JSON.parse(localStorage.getItem("watched"));return null===e?[]:e}catch(e){console.log(e)}}
...
//# sourceMappingURL=my-library.0642d6fd.js.map
