!function(){var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},t={},a={},n=e.parcelRequirea6b3;null==n&&((n=function(e){if(e in t)return t[e].exports;if(e in a){var n=a[e];delete a[e];var o={id:e,exports:{}};return t[e]=o,n.call(o.exports,o,o.exports),o.exports}var r=new Error("Cannot find module '"+e+"'");throw r.code="MODULE_NOT_FOUND",r}).register=function(e,t){a[e]=t},e.parcelRequirea6b3=n);n("iU1Pc");var o=n("g2eb2");
...
r.myLibraryBtn.addEventListener("click",u),
...
r.closeModalBtn.addEventListener("click",p),r.backdrop.addEventListener("click",(function(e){e.currentTarget===e.target&&p()})),
...
r.watchedHeader.addEventListener("click",u),r.queueHeader.addEventListener("click",(function(){var e;
...
i=JSON.parse(localStorage.getItem("watched"));var s;s=JSON.parse(localStorage.getItem("queue"));function u(){var e;
//! Перезаписываем в локальную переменную (results) значение всего (localStorage)
...
//! +++++++++++++++++++++++ Функции для МОДАЛКИ +++++++++++++++++++++++++++
function p(){window.removeEventListener("keydown",y),document.body.classList.remove("show-modal"),r.InfoMovie.innerHTML=""}function y(e){"Escape"===e.code&&p()}
